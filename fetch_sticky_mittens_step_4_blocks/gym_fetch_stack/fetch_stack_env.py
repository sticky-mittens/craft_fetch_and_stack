...
class FetchStackEnv(robot_env.RobotEnv):
    ...
    def _get_obs(self):
        ...
        annotated_obs['grip_pos'] = grip_pos
        annotated_obs['gripper_state'] = gripper_state
        annotated_obs['grip_velp'] = grip_velp
        annotated_obs['gripper_vel'] = gripper_vel
        ...
        for i in range(self.num_blocks):
            ...
            object_details = {}
            object_details["pos"] = object_i_pos
            object_details["rel_pos"] = object_i_rel_pos
            object_details["rel_vel"] = object_i_velp
            annotated_obs["object_" + str(i)] = object_details
        ...
        return {
            ...
            'annotated_obs': annotated_obs.copy(),
        }
