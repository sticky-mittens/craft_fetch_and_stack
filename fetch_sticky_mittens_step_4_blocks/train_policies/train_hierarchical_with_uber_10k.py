...
parser.add_argument('--visualise',action='store_true', default=False, help='to visualise')
...
for current_learning_level in range(args.starting_level, args.total_learning_levels):
    ...
    mb = []
    while reward_avg < 0.85 or episode_index < 10000 :
        obs = env.reset()
        ...
        print(time.ctime(), "At episode ", episode_index, " end reward - ", reward)
