...
import sys
import os
sys.path.append("./Pre-trained models/")
...
class Agent:
    def __init__(self, n_states, n_actions, n_goals, action_bounds, capacity,
        ...
        self.state_normalizer = Normalizer(self.n_states, default_clip_range=5)
    ...
    def save_weights(self):
        torch.save({"actor_state_dict": self.actor.state_dict(),
                    ...
                    "goal_normalizer_std": self.goal_normalizer.std}, self.filename)
    ...
    def _update_normalizer(self, mini_batch):
        ...
        if (states is not None) and (goals is not None):
            ...
            print("Empty normalizer handled")
