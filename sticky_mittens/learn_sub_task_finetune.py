...
def learn(env, goal_name, episodes, initial_positions, actions_available, visualise = False, model_folder = "./models"):

    print("No of initial positions - ", len(initial_positions), " for goal - ", goal_name)
