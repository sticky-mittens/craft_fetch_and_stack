...
# current_goal = 'get[gold]'
# # current_goal = 'make[bed]'

# recipes_path = "resources/recipes.yaml"
# hints_path = "resources/hints.yaml"
# no_of_init_episodes = 5000
# learning_freq = 20
# visualise = False
...
parser.add_argument('--uid', default='gold_0', type=str, help='Unique id for this run')
...
env_sampler = env_factory.EnvironmentFactory(
  args.recipes_path, args.hints_path, max_steps=args.max_steps, reuse_environments=False,
