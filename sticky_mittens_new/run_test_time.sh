...
# nohup python -u play_composed_craft.py --current-goal get[gem] --current-thing gem --uid gem_5_finetune --max-steps 500 > logs/gem_5_finetune_test.log &
...
# nohup python -u play_composed_craft.py --current-goal get[gem] --current-thing gem --uid gem_50_finetune --max-steps 500 > logs/gem_50_finetune_test.log &
...
# viz
python play_composed_craft.py --current-goal get[gem] --current-thing gem --uid gem_50_finetune --max-steps 500
